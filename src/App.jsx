          ...
          return(
            <div style={{paddingTop:36}}>
              ...
              <div style={{background:"linear-gradient(135deg,rgba(255,90,140,0.18),rgba(255,140,80,0.12))",border:"1.5px solid rgba(255,140,160,0.4)",borderRadius:24,padding:"24px 20px",marginBottom:16,textAlign:"center",backdropFilter:"blur(14px)"}}>
                ...
                <a href="https://px.a8.net/svt/ejp?a8mat=XXXXXX" target="_blank" rel="noopener noreferrer" className="cta-btn" style={{display:"block",padding:"17px",background:"linear-gradient(135deg,#ff5a8c,#ff7a5a)",borderRadius:50,color:"#fff",fontSize:15,fontWeight:900,textDecoration:"none",letterSpacing:"0.05em",marginBottom:10,boxShadow:"0 8px 28px rgba(255,90,140,0.5)",transition:"all 0.3s cubic-bezier(0.34,1.56,0.64,1)"}}>
                  💌 初回無料で運命を占ってもらう
                </a>
                <a href="https://px.a8.net/svt/ejp?a8mat=YYYYYY" target="_blank" rel="noopener noreferrer" className="cta-btn" style={{display:"block",padding:"14px",background:"rgba(255,255,255,0.1)",border:"1px solid rgba(255,255,255,0.25)",borderRadius:50,color:"#fff",fontSize:14,fontWeight:700,textDecoration:"none",transition:"all 0.3s"}}>
                  💬 チャットで気軽に相談する
                </a>
              </div>
